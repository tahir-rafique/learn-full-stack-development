...
// Step-1:  as we are using custom module, so give its path in require fnc.
...
// Step-2: use that module, e.g: replaceHtml fnc here.
//  instead of this below normal fnc, we going to use exported module(which is also the same fnc function but as module).
